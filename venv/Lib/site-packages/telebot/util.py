...
from money_bot import types
from money_bot.service_utils import is_pil_image, is_dict, is_string, is_bytes, chunks, generate_random_token, pil_image_to_file
...
def antiflood(function: Callable, *args, **kwargs):
    ...
    :return: None
    """
    from money_bot.apihelper import ApiTelegramException
